...
- Used in **both off-chain and on-chain verification**, since both need a valid proof first.
...
```
- Loads the circuit’s **`verification_key.json`** from the `/circuits` folder.  
